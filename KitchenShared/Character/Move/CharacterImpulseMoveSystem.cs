...
{
    [DisableAutoCreation]
    public class CharacterImpulseMoveSystem : JobComponentSystem
    {
        ...
        private struct CharacterMoveControlJob : IJobChunk
        {
            ...
            public unsafe void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
            {
                ...
                for (var i = 0; i < chunk.Count; i++)
                {
                  ...
                  //  FSLog.Info($"CharacterImpulseMoveSystem,entity:{entity},velocityPredictData:{velocityPredictData.Linear}");
               ...
               //     FSLog.Info($"CharacterImpulseMoveSystem begin,entity:{entity},newPosition:{newPosition},newVelocity:{newVelocity}");
               ...
               //     FSLog.Info($"CharacterImpulseMoveSystem end,entity:{entity},newPosition:{newPosition},newVelocity:{newVelocity}");
